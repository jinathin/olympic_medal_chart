...
labels = ['Canada(315)', 'USA(167)', 'Norway(159)']
sizes = [315, 167, 159]
...
plt.title("Comparing Gold Medals between CAD, USA, and NOR")
plt.xlabel("Canada has won the most gold medals from winter olympics!!!!")
plt.show()
